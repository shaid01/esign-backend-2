...
{
    public class CertificateDetailsExtendedDTO
    {

        public CertificateDetailsExtendedDTO(CertificateDetails certificate)
        {
            if (certificate == null)
                return;
            ...
            NotarioLicenseNumber = certificate.NotarioLicenseNumber;
            Job = certificate.Job;
